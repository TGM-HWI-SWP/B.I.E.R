"""Database Service - Wrapper around the PostgreSQL repository."""
...
class DbService(DatabasePort):
    ...
    def __init__(self, repository: PostgresRepository):
        """Initialize the database service with a PostgreSQL repository.

        Args:
            repository (PostgresRepository): The PostgreSQL repository instance.
        """
    ...
    def update(self, collection: str, document_id: str, data: Dict) -> bool:
        ...
        Args:
            ...
            data (Dict): The updated fields and their values.
